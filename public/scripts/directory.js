// Note: type is now text[] — each org can belong to multiple categories.
const ORGANIZATIONS_FALLBACK = [
    { name: "Movement Strategy Center", description: "Community organizing fiscal sponsor focused on activating donor capital through an ecosystem approach, backing change agents and capital innovators.", website: "https://movementstrategy.org/donor-advised-fund", type: ["Investment Intermediary"] },
    ...
    { name: "NETA Foundation", description: "GrantVestments™ DAF platform supports donors in deploying DAF dollars as catalytic, VC-style investments in breakthrough science & other thematics. Can serve as both DAF sponsor and investment manager.", website: "https://www.netafoundation.org", type: ["DAF Sponsor", "Investment Intermediary"] },
    { name: "Abundance Capital", description: "DAF Sponsor, and nonprofit venture philanthropy platform empowering donors to make high-impact investments.", website: "https://www.abundancecap.org/", type: ["DAF Sponsor", "Investment Intermediary"] },
    ...
    { name: "Prime Coalition", description: "Catalytic funding organization facilitating climate impact investments through DAFs.", website: "https://primecoalition.org", type: ["Investment Intermediary"] },
    { name: "Social Finance", description: "Impact investment advisory firm with DAF impact investing solutions", website: "https://socialfinance.org", type: ["Investment Intermediary"] },
    ...
    { name: "MissionPoint Partners", description: "Impact investment manager and advisor focused on environmental issues.", website: "http://mppgrp.com/portfolio/", type: ["Investment Intermediary"] },
    { name: "Impact Charitable", description: "Diligencing, and term structuring platform for impact investments.", website: "https://impactcharitable.org/", type: ["DAF Sponsor", "Investment Intermediary"] },
...
function renderDirectory() {
    const filtered = ORGANIZATIONS.filter(org => {
        const types = Array.isArray(org.type) ? org.type : (org.type ? [org.type] : []);
        const matchesFilter = currentDirectoryFilter === 'all' || types.includes(currentDirectoryFilter);
